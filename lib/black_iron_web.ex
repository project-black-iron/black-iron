defmodule BlackIronWeb do
  ...
  def static_paths, do: ~w(assets fonts images favicon.ico robots.txt service-worker.js)
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: BlackIronWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {BlackIronWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        statics: BlackIronWeb.static_paths()
    end
  end
