defmodule BlackIronWeb.CoreComponents do
  ...
  def input(%{type: "select"} = assigns) do
    ...
    <.label>
      <%= @label %>
      <select name={@name} multiple={@multiple} {@rest}>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BlackIronWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BlackIronWeb.Gettext, "errors", msg, opts)
    end
  end
